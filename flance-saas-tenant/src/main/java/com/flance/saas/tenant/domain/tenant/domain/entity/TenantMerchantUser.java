...
@Table(tableName = "sys_flance_saas_tenant_merchant_user", indexes = {
        @Index(columns = {"user_id", "tenant_id"}, indexName = "un_user_tenant_id", indexType = Index.IndexType.UNIQUE),
})
@TableName("sys_flance_saas_tenant_merchant_user")
public class TenantMerchantUser extends BaseTable {
